...
using namespace Gameplay;
	...
	{
		leftBoundary.setSize(sf::Vector2f(vertical_boundary_width, vertical_boundary_height));
	...
	{
		rightBoundary.setSize(sf::Vector2f(vertical_boundary_width, vertical_boundary_height));
	...
	{
		centerLine.setSize(sf::Vector2f(center_line_width, center_line_height));
		centerLine.setPosition(center_line_position_x, center_line_position_y);
		centerLine.setFillColor(center_line_color);
	}
	void Gameplay::Boundary::createBottomBoundary()
	{
